    ...
    <div className="ps-section--custom">
        <div className="container">
            ...
            <div className="ps-section__content">
                ...
                <p>Our Website links to other websites that may collect personally identifiable information about you. Nuvio.in is not responsible for the privacy practices or the content of those linked websites.</p>
                ...
                <h3>10.Questions?</h3>
                <p>Questions regarding this statement should be directed to Seller support by raising an incident from your  dashboard or mail.</p>
            </div>
        </div>
    </div>
);
