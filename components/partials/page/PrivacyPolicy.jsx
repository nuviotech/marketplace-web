    ...
    <div className="ps-section--custom">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h6>NuvioSellers Admin| 23th Mar, 2023 | </h6>
            </div>
            <div className="ps-section__content">
                ...
                <p className='text-justify'>We use personal information to provide the services you request. To the extent we use your personal information to market to you, we will provide you the ability to opt-out of such uses. We use your personal information to resolve disputes; troubleshoot problems; help promote a safe service; collect money; measure consumer interest in our products and services, inform you about online and offline offers, products, services, and updates; customize your experience; detect and protect us against error, fraud and other criminal activity; enforce our terms and conditions; and as otherwise described to you at the time of collection.
                ...
                <h5>Cookies</h5>
                <p className='text-justify'>A "cookie" is a small piece of information stored by a web server on a web browser so it can be later read back from that browser. Cookies are useful for enabling the browser to remember information specific to a given user. We place both permanent and temporary cookies in your computer's hard drive. The cookies do not contain any of your personally identifiable information.</p>

                <h3>3.Sharing of personal information</h3>
                <p className='text-justify'> We will share your personal data with third parties only with the consent of the individual to whom the data belongs, or if there are specific legal provisions allowing such sharing without consent.We may share personal information with our other corporate entities and affiliates. These entities and affiliates may market to you as a result of such sharing unless you explicitly opt-out.
                ...
                <p className='text-justify'>Our Website links to other websites that may collect personally identifiable information about you. Nuvio.in is not responsible for the privacy practices or the content of those linked websites.</p>
                ...
                <p className='text-justify'>We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications from us on behalf of our partners, and from us in general, after setting up an account.</p>
                <h3>7.Advertisements on Nuvio.com</h3>
                <p className='text-justify'>We use third-party advertising companies to serve ads when you visit our Website. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you.</p>
                <h3>8.Your Consent</h3>
                <p className='text-justify'>By using the Website and/ or by providing your information, you consent to the collection and use of the information you disclose on the Website in accordance with this Privacy Policy, including but not limited to Your consent for sharing your information as per this privacy policy.
                    If we decide to change our privacy policy, we will post those changes on this page so that you are always aware of what information we collect, how we use it, and under what circumstances we disclose it.
                </p>
                <h3>9.Grievance Officer</h3>
                <p className='text-justify'>In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:
                    Mr. Bir Singh
                    Shop No-2,Shati Dham Apt,sec-21,Ghansoli,400701.
                    Contact -7718895734
                    Email: nuviotechnologies@gmail.com
                </p>
                <h3>10.Questions?</h3>
                <p className='text-justify'>Questions regarding this statement should be directed to Seller support by raising an incident from your  dashboard or mail.</p>
            </div>
        </div>
    </div>
);
