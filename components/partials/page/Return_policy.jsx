        ...
        <div className="container">
            ...
            <div className="ps-section__content">
                <p>Happy shopping !!
                    ...
                    Most items listed by the sellers on the website are eligible for returns/replacements/exchange, except those that are specifically specified as “not returnable”.

                    For all the returned products, the refund will be issued to the wallet. For instances where the refund is not shown, please wait for 48 hours as the processing might take time. After 48 hours of confirmation of refund, if there is a dispute please write to us or contact the customer care.

                    Gift cards, downloadable software products are non returnable along with those items specified as non returnable.

                    We shall initiate the process of customer refund within 15 [Fifteen] working days from the date of request made to us. We will send the refund payment in your wallet.
